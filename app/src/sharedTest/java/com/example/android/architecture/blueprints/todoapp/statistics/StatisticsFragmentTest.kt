...
//        onView(withId(R.uid.stats_active_text)).check(matches(isDisplayed()))
//        onView(withId(R.uid.stats_active_text)).check(matches(withText(expectedActiveTaskText)))
//        onView(withId(R.uid.stats_completed_text)).check(matches(isDisplayed()))
//        onView(withId(R.uid.stats_completed_text)).check(matches(withText(expectedCompletedTaskText)))
//    }
//}
