...
//        onView(withId(R.uid.add_task_title)).perform(clearText())
//        onView(withId(R.uid.add_task_description)).perform(clearText())
//        onView(withId(R.uid.fab_save_task)).perform(click())
//
//        // THEN - Entered Task is still displayed (a correct task would close it).
//        onView(withId(R.uid.add_task_title)).check(matches(isDisplayed()))
//    }
//
//    @Test
...
//        onView(withId(R.uid.add_task_title)).perform(replaceText("title"))
//        onView(withId(R.uid.add_task_description)).perform(replaceText("description"))
//        onView(withId(R.uid.fab_save_task)).perform(click())
//
